package com.acme.digobe.security.service;
...
import com.acme.digobe.security.domain.persistence.RoleRepository;
import com.acme.digobe.security.domain.persistence.UserRepository;
import com.acme.digobe.security.domain.service.UserService;
import com.acme.digobe.security.domain.service.communication.AuthenticateRequest;
import com.acme.digobe.security.domain.service.communication.AuthenticateResponse;
import com.acme.digobe.security.domain.service.communication.RegisterRequest;
import com.acme.digobe.security.domain.service.communication.RegisterResponse;
import com.acme.digobe.security.middleware.JwtHandler;
import com.acme.digobe.security.middleware.UserDetailsImpl;
    ...
    public ResponseEntity<?> register(RegisterRequest request) {
        ...
        try {
            ...
            User user = new User()
                    ...
                    .withPassword2(encoder.encode(request.getPassword2()))
